...
# =======================================================================================
# Pi 3 UEFI SSD Installer (ZFS Root) - DEBUG HOST
# =======================================================================================
# Installs NixOS onto a Samsung T5 SSD using UEFI boot (pftf/RPi3 firmware).
...
#
# Usage: ./hosts/pi3/install-ssd.sh (run from configs/nixos directory)
# =======================================================================================
...
# RPi3 UEFI firmware (different from RPi4!)
UEFI_VERSION="v1.38"
UEFI_URL="https://github.com/pftf/RPi3/releases/download/${UEFI_VERSION}/RPi3_UEFI_Firmware_${UEFI_VERSION}.zip"
...
log "Target: $DISK_ID"
log "This will install Pi 3 config for debugging with HDMI/ethernet"
...
log "Step 2: Installing pftf RPi3 UEFI firmware (${UEFI_VERSION})..."
TEMP_DIR=$(mktemp -d)
cd "$TEMP_DIR"
...
log "  2. Connect to Raspberry Pi 3"
log "  3. Connect HDMI and ethernet for debugging"
log "  4. Remove any SD card"
log "  5. Power on"
log ""
log "Watch HDMI output to debug boot process."
log "=============================================="
