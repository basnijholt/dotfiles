...

{
  ...
  #   iscsiadm -m discovery -t sendtargets -p 192.168.1.214
  #   iscsiadm -m node -T iqn.2005-10.org.freenas.ctl:jbweston1 -p 192.168.1.214 --login
  #   lsblk

  services.openiscsi = {
    enable = true;
    name = "iqn.2024-01.org.nixos:${config.networking.hostName}";
    discoverPortal = "192.168.1.214";
