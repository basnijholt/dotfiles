...
if [[ $- == *i* ]]; then
    ...
    alias vcl='CLAUDE_CODE_USE_VERTEX=1 CLOUD_ML_REGION=global ANTHROPIC_MODEL="claude-opus-4-8" ANTHROPIC_SMALL_FAST_MODEL="claude-haiku-4-5" claude --dangerously-skip-permissions '
